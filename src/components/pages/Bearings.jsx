...
// Import bearing images
import ceramicBearing from '../../assets/Quad & Inline Bearings/627-608 Hybrid Antirust WB Ceramic Bearing/1000211055.png'
import inlineBearing from '../../assets/Quad & Inline Bearings/627-608 Quad & Inline Bearing [16 pcs]/627_608 Quad &Inline Bearing [16 Pcs ]_.png'
import practiceBearing from '../../assets/Quad & Inline Bearings/627-608 Quad & Inline Practice Bearing [16 pcs]/627_608 Quad & Inline practice Bearing [16 pcs](1).png'
import minimizerBearing from '../../assets/Quad & Inline Bearings/Minimizer Bearing [11 Ball]/Minimizer Bearing (11 Ball)_.png'
import overlapBearing from '../../assets/Quad & Inline Bearings/Overlap Bearing [11 Ball]/Overlap Bearing (11 Ball)_.png'
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto mt-16 mb-12 bg-white p-8 rounded-lg shadow-lg">
        <h2 className="text-2xl font-heading font-bold text-gray-900 mb-4">Why Choose LGM Bearings?</h2>
        <div className="prose prose-lg text-gray-600">
          <p className="mb-4">
            LGM's bearings are engineered for superior performance and longevity. Each bearing is 
            precision-manufactured to strict tolerances, ensuring smooth, consistent rolling and 
            maximum speed potential.
          </p>
          <p>
            Whether you're a competitive skater or recreational enthusiast, our range of bearings 
            offers the perfect balance of speed, durability, and value for your skating needs.
          </p>
        </div>
      </div>
